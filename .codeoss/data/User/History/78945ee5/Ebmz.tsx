        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center gap-2"><Phone className="h-4 w-4 text-light-blue" /> <span className="text-base font-normal text-silver">+919339275140</span></li>
              <li className="flex items-center gap-2"><MapPin className="h-4 w-4 text-light-blue" /> <span className="text-base font-normal text-silver">San Francisco, CA</span></li>
            </ul>
          </div>
        </div>
