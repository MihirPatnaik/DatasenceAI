    ...
    <div className="pt-20 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="text-center mb-16 mt-16" // Added mt-16 for top margin to create symmetry/gap
        >
        ...
        </motion.div> {/* Added closing tag here to fix the error */}
        ...
        {/* Trust Signals Section (Updated to remove gaps) */}
        <section className="bg-gradient-to-r from-light-blue/10 to-deep-blue/10">
