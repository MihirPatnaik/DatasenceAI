...
import { Check, Database, Image, Video, Mic, MessageSquare, ArrowRight } from 'lucide-react';
import { Link } from 'react-router-dom';

const AIDataLabelingPage: React.FC = () => {
  return (
    <div className="pt-0 pb-0"> {/* Removed pt-20 and pb-16 to eliminate top and bottom gaps */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Hero Section with Removed Gap */}
        <motion.div
          initial={{ opacity: 0, y: 0 }} {/* Removed y: 20 to eliminate initial animation gap */}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          className="text-center mb-0" {/* Removed mt-16 and reduced mb-16 to mb-0 to remove gap below hero */}
        >
        ...
        <section className="mb-0 bg-gradient-to-r from-light-blue/20 to-deep-blue/20 rounded-2xl p-8 shadow-md"> {/* Removed mb-16 to eliminate gap below */}
        ...
        {/* Our Expertise */}
        <section className="mb-0"> {/* Removed mb-16 to eliminate gap below */}
        ...
        {/* How It Works */}
        <section className="mb-0"> {/* Removed mb-16 to eliminate gap below */}
          <h2 className="text-2xl font-bold text-deep-blue mb-6">How It Works?</h2>
        ...
        {/* CTA Section */}
        <div className="flex flex-col items-center justify-center py-0 px-6 text-center"> {/* Removed py-12 to eliminate padding */}
          ...
          <div className="mt-0 w-full max-w-3xl bg-blue-100 p-8 shadow-md rounded-lg text-center"> {/* Removed mt-10 to eliminate gap */}
            ...
            <p className="flex items-center justify-center gap-2 mt-3 text-lg text-gray-700">
              <span role="img" aria-label="phone">📞</span> Call: +91 XXXXXXXX
            </p>
          </div>
        </div>

        {/* Trust Signals Section */}
        <section className="py-0 bg-gradient-to-r from-light-blue/10 to-deep-blue/10"> {/* Removed py-20 to eliminate padding */}
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl font-extrabold text-deep-blue mb-0"> {/* Removed mb-8 to eliminate gap below heading */}
              Trusted by Leading Retail & E-Commerce Brands
            </h2>
            <div className="flex flex-wrap justify-center gap-8 mt-0"> {/* Removed mt-8 to eliminate gap above cards */}
              <div className="p-4 bg-white border border-silver rounded-xl shadow-md">
                <div className="flex items-center gap-2">
                  <Check className="h-6 w-6 text-green-500" />
                  <span className="text-xl font-bold text-deep-blue">99.9% Labeling Accuracy</span>
                </div>
              </div>
              <div className="p-4 bg-white border border-silver rounded-xl shadow-md">
                <div className="flex items-center gap-2">
