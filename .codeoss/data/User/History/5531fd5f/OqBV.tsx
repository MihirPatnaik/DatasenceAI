  ...
  return (
    <div className="pt-20 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* CTA Section */}
        <div className="flex flex-col items- justify-center py-12 px-6 text-center">
          <div className="w-full max-w-3xl bg-blue-10 p-8 shadow-lg rounded-lg flex flex-col items-center">
