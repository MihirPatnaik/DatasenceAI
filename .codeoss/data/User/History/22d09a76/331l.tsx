...
const BusinessAutomationPage: React.FC = () => {
  ...
  return (
    <div className="pt-20 pb-16">
      ...
      <section className="relative text-center py-20 bg-gradient-to-r from-light-blue/20 to-deep-blue/20 shadow-lg mt-16"> {/* Added mt-16 for top margin */}
      ...
      <section className="py-20 bg-gradient-to-r from-light-blue/10 to-light-blue/10 rounded-2xl shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-deep-blue text-center mb-12">How Business Automations Works</h2>
