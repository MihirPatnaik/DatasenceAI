...
const ServicesPage = () => {
  const services = [
    ...
    { icon: Cloud, title: 'Google Cloud & AI Consulting', description: 'Expert guidance for Google Cloud implementation and AI model deployment.', features: ['Cloud Migration', 'AI/ML Model Deployment', 'Google Workspace Setup', 'Security & Compliance'], price: '$150/hour', path: '/google-cloud-ai' }, // Updated path
