    ...
    <div className="pt-20 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-deep-blue mb-6">Get in Touch</h1>
          <p className="text-xl font-normal text-silver max-w-3xl mx-auto">Have a question or ready to start your AI journey? We're here to help.</p>
        </motion.div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 bg-blue p-4">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }} whileHover={{ scale: 1.05, boxShadow: "0px 10px 20px rgba(0, 0, 0, 0.15)" }} className="p-6 bg-light-gray rounded-xl shadow-md hover:bg-light-blue/10 transition-transform duration-150 ease-in-out">
            ...
            <p className="text-base font-normal text-silver text-center">Send us an email anytime</p>
          </motion.div>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }} whileHover={{ scale: 1.05, boxShadow: "0px 10px 20px rgba(0, 0, 0, 0.15)" }} className="p-6 bg-light-gray rounded-xl shadow-md hover:bg-light-blue/10 transition-transform duration-150 ease-in-out">
            ...
            <p className="text-base font-normal text-silver text-center">Mon-Fri from 9am to 6pm PST</p>
          </motion.div>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.3 }} whileHover={{ scale: 1.05, boxShadow: "0px 10px 20px rgba(0, 0, 0, 0.15)" }} className="p-6 bg-light-gray rounded-xl shadow-md hover:bg-light-blue/10 transition-transform duration-150 ease-in-out">
            ...
            <p className="text-base font-medium text-light-blue mb-2 text-center">San Francisco, CA</p>
            <p className="text-base font-medium text-light-blue mb-1 text-center">Mumbai, India (HQ)</p>
            <p className="text-base font-medium text-light-blue mb-2 text-center">548 Market St, San Francisco, CA 94104 (U.S.)</p>
            <p className="text-base font-normal text-silver text-center">Serving clients globally</p>          </motion.div>
        </div>
