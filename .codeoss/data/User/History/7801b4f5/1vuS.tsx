      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 bg-blue p-4">
          ...
          >
            ...
            <p className="text-black text-center">Send us an email anytime</p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <p className="text-black text-center">Mon-Fri from 9am to 6pm PST</p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <p className="text-black text-center">Silicon Valley Innovation Hub</p>
          </motion.div>
        </div>
