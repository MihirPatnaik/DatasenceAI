      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mb-8 space-x-1">
          <button
            ...
            className={`px-4 py-2 text-sm font-medium ${currency === 'usd' ? 'bg-light-blue text-white' : 'bg-silver text-deep-blue'} rounded-l-md transition`}
          >
            USD
          </button>
          <button
            onClick={() => setCurrency('inr')}
            className={`px-4 py-2 text-sm font-medium ${currency === 'inr' ? 'bg-light-blue text-white' : 'bg-silver text-deep-blue'} transition`}
          >
            INR
          </button>
          <button
            onClick={() => setCurrency('gbp')}
            className={`px-4 py-2 text-sm font-medium ${currency === 'gbp' ? 'bg-light-blue text-white' : 'bg-silver text-deep-blue'} rounded-r-md transition`}
          >
            GBP
          </button>
        </div>
          ...
          {plans.map((plan, index) => (
            ...
            >
              <div className="p-8">
                ...
                <div className="mb-6">
                  <span className="text-4xl font-bold text-light-blue">
                    {plan.price[currency]}
                  </span>
                  {plan.price[currency] !== 'Custom' && (
                    <span className="text-base font-normal text-silver">/month</span>
                  )}
                </div>
                ...
                <Link
                  to="/contact"
                  className="block w-full text-center bg-light-blue text-white py-3 rounded-md hover:bg-deep-blue transition font-medium"
                >
                  Get Started
                </Link>
              </div>
