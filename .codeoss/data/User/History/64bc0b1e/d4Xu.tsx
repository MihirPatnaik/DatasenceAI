        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <Link
                to="/services"
                className="inline-flex items-center justify-center px-6 py-3 border border-silver text-base font-medium rounded-md text-silver bg-transparent hover:bg-silver/10"
              >
                Explore Services
              </Link>
            </div>
              ...
              >
                {feature.path ? (
                  <Link to={feature.path} className="block h-full">
                    ...
                    <p className="text-silver text-center">{feature.description}</p>
                  </Link>
                ) : (
                  <>
                    <img 
