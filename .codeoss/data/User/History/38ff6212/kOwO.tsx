...
import BusinessAutomationPage from "./pages/BusinessAutomationPage"; // Import the new page
    ...
    <div className="min-h-screen bg-gradient-to-br from-light-blue/10 via-white to-light-gray">
      ...
      <main>
        <Routes>
          ...
          <Route path="/business-automation" element={<BusinessAutomationPage />} /> {/* Add route */}
        </Routes>
      </main>
      <Footer />
    </div>
